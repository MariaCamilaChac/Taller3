...
public class Punto5 { //print the matrix that is not part of the diamond generated by the diagonals

		
	public static void cargarArray(String array[][], String [] Num2 ) { //load up the matrix with the number written by the user
		int mas=0;
	...
	public static void ImprimirRombo(String[][] array, int T){  // Print the parts that do not correspond to the diamond
		
		if (T%2==0	) { //conditional for the length matrix, if it's even number
			
		for (int i = 0; i < array.length; i++) {
			for (int j = 0; j < array.length ; j++) {
				//conditional that create the diagonals
